...
#file path.
FILE_PATH = "./UCSpathfinding/cities.csv"
...
def uniform_cost_search(cities, start, end):
        ...
        if current not in visited:
            ...
            for city in neighbors: 
                ...
                if city not in visited:
                    ...
                    print(f'checking {current}({neighbors}) -> {city}, total cost: {total_cost}')#############################
...
if __name__ == "__main__":
    ...
    while True:
        try:
            print("Hello Fireman, Im an intelligent agent pathfinder who can give you directions with minimal cost.") 
